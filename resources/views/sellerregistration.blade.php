...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 bg-white p-5">
            <h3 class="pb-3 text-center">Create Seller Account</h3>

            @if(session('info'))
                <div class="alert alert-info" style="background-color: lightgreen">
                    {{ session('info') }}
                </div>
            @endif
            <div class="form-style">
                <form action="{{route('sellerinsert')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group pb-3">
                        <input type="text" placeholder="Owner Name" name="names" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" required>
                    </div>
                    <div class="form-group pb-3">
                        <input type="text" placeholder="Store Name" name="storenames" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" required>
                    </div>
                    <div class="form-group pb-3">
                    ...
                    <div class="form-group pb-3">
                        <input type="number" placeholder="TIN" name="tin" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    </div>

                    <div class="form-group pb-3">
                        <input type="file" placeholder="Business Certificate" name="business" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    </div>
