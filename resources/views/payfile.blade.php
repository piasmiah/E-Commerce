        ...
        <div class="container">
            ...
            <div class="header-user-actions">
                ...
                <div class="dropdown">
                    ...
                    <ul>
                        <li><a href="{{ route('purchase',['id'=>$user->id]) }}" style="font-size: 15px">Your Products</a></li>
        ...
        <div class="container">
            ...
            <ul class="desktop-menu-category-list">
                ...
                <li class="menu-category">
                    <a href="{{route('dashboard',['id'=>$user->id])}}" class="menu-title">Ecommerce</a>
                </li>
                <li class="menu-category">
...
<div class="container payment-container">
    ...
    @if($uses->type==='Regular')
        <h3 class="text-center">You paid <strong>150tk</strong>  for this ad. You will get <strong>105Tk</strong>.</h3>
    @elseif($uses->type==='Standard')
            <h3 class="text-center">You paid <strong>300tk</strong> for this ad. You will get <strong>210Tk</strong>.</h3>
    @elseif($uses->type==='Premium')
        <h3 class="text-center">You paid <strong>600tk</strong> for this ad. You will get <strong>420Tk</strong>.</h3>

    @endif

    <form class="payment-form" action="{{ route('donepaym',['id'=>$user->id]) }}" method="post">
        @csrf
        <input type="hidden" name="id" value="{{$user->id}}">
        <input type="text" name="ids" value="{{$uses->id}}">
...
<script>
    function openInputField(element) {
        var parentRow = element.closest('tr');
        var inputField = parentRow.querySelector('.input-field');
