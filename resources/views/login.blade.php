    ...
    <nav class="desktop-navigation-menu">
        ...
        <div class="container">
            ...
            <ul class="desktop-menu-category-list">
                ...
                <li class="menu-category">
                    <a href="#" class="menu-title" style="color: blue;">Sign in</a>
                </li>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 bg-white p-5">
            <h3 class="pb-3 text-center">Signin</h3>
            ...
            <div class="form-style">
                <form action="{{ route('form-container') }}" method="post">
                    ...
                    <div class="form-group pb-3">
                        <input type="email" placeholder="Username" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    </div>
                    ...
                    <div class="pb-2">
                        <button type="submit" style="background-color: hsl(51 , 100% , 50%); font-weight: bold; border-color: hsl(51 , 100% , 50%)" class="btn btn-dark w-100 font-weight-bold mt-2 btn-submit" id="submitBtn">
